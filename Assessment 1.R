...
#for missing data patterns we can use the histMiss() and marginplot() functions for the continuous variables 
#and the barMiss() function for the categorical variables.
marginplot(df[c(1,2)])
